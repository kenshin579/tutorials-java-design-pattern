...
public class ConnectionPool {
    ...
    private Vector freePool = new Vector(1, 1);
    // 사용 가능한 Connection 객체에 대한 저장소

    private Vector occupiedPool = new Vector(1, 1);
    ...
    public Connection getFreeConnection() {
        Connection con = (Connection) freePool.firstElement();
    ...
    public void removeConnectionFromOccupiedPool(Connection con) {
        ...
        for (int i = 0; i < occupiedPool.size(); i++) {
            _con = (Connection) occupiedPool.elementAt(i);
